  ...
  <div class="home">
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        ...
        <p class="lead">
          Simple authentication application built with MEVN Stack using Express,
          Node.js, Vue.js and MongoDB by Codebook Inc.
        </p>
      </div>
    </div>
    <div class="row">
        ...
        <div class="card bg-dark text-white">
          <div class="card-body">
            ...
            <p class="card-text">
              ...
              documents with schemata. MongoDB is developed by MongoDB Inc.
            </p>
            <a
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="card bg-success text-white">
          <div class="card-body">
            ...
            <a href="https://nodejs.org/" target="_blank" class="btn bg-white"
              >More Info.</a
            >
          </div>
        </div>
